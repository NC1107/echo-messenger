...
pub async fn run_migrations(pool: &PgPool) {
    let migrations: &[&str] = &[
        ...
        include_str!("../migrations/020_message_search_and_mute.sql"),
        include_str!("../migrations/021_banned_members.sql"),
        include_str!("../migrations/022_cleanup_empty_groups.sql"),
    ];
